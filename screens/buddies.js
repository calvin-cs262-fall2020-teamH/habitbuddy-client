...
export default function Buddies({ navigation }) {
    const [buddies, setReviews] = useState([
        ...
        {name: 'Kelsey Yen', category: 'Spiritual', goal: 'I want to rest every day for an hour', hobby: 'Engineering', email: 'coolguy@yeet.com', number: 1234573885, pic: '../assets/images/george.jpg', key: '3'},
        {name: 'Belina Sainju', category: 'Relaxation', goal: 'I want watch TV every day', hobby: 'Reading', email: 'coolguy@yeet.com', number: 1234573885, pic: '../assets/images/george.jpg', key: '4'},
        {name: 'Joe Pastucha', category: 'Relaxation', goal: 'I want to watch 2 movies every week', hobby: 'Sleeping', email: 'coolguy@yeet.com', number: 2314573885, pic: '../assets/images/george.jpg', key: '5'},
        {name: 'Nathan Strain', category: 'Spiritual', goal: 'I want to meditate daily', hobby: 'School', email: 'coolguy@yeet.com', number: 1234573885, pic: '../assets/images/george.jpg', key: '6'},
