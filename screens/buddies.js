...
export default function Buddies({ navigation }) {
    const [buddies, setReviews] = useState([
        ...
        {name: 'Belina Sainju', category: 'Relaxation', goal: 'I want watch TV every day', hobby: 'Reading', email: 'coolguy@yeet.com', number: 1234573885, pic: 'https://scontent-ort2-2.xx.fbcdn.net/v/t1.0-9/94386001_3052697268125747_8543896262028558336_o.jpg?_nc_cat=108&ccb=2&_nc_sid=09cbfe&_nc_ohc=HB2iMgmeyiMAX-xH8b0&_nc_ht=scontent-ort2-2.xx&oh=80085c34f488d26877a9d5e5cebc7074&oe=5FC74D3E', key: '4'},
        {name: 'Joe Pastucha', category: 'Relaxation', goal: 'I want to watch 2 movies every week', hobby: 'Sleeping', email: 'coolguy@yeet.com', number: 2314573885, pic: 'https://scontent-ort2-2.xx.fbcdn.net/v/t1.0-9/49411157_2482634981749821_1257420489870016512_o.jpg?_nc_cat=108&ccb=2&_nc_sid=09cbfe&_nc_ohc=VpIkl5ZG6WwAX-oBa9c&_nc_ht=scontent-ort2-2.xx&oh=89e58d115252bffe32dc7fa71a09a703&oe=5FC99EE5', key: '5'},
            ...
            <FlatList data={buddies} renderItem={({ item }) => (
                ...
                <TouchableOpacity onPress={() => navigation.navigate('BuddyDetails', item)}>
                    ...
                    <Card>  
                        ...
                        <Image source = {{uri: item.pic}} style = {{width: 50, height: 50, position: 'absolute', borderRadius: 6,}}/> 
