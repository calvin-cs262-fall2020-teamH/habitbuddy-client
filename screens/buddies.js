...
export default function Buddies({navigation}) {
    const [buddies, setReviews] = useState([
        ...
        },
        {
            name: 'Dawson Buist',
            category: 'Education',
            goal: 'I want to read one book every week',
            hobby: 'Hacking',
            email: 'coolguy@yeet.com',
            number: 1234573885,
            pic: '../assets/images/george.jpg',
        ...
        },
        {
            name: 'Kelsey Yen',
            category: 'Spiritual',
            goal: 'I want to rest every day for an hour',
            hobby: 'Engineering',
            email: 'coolguy@yeet.com',
            number: 1234573885,
            pic: '../assets/images/george.jpg',
        ...
        },
        {
            name: 'Belina Sainju',
            category: 'Relaxation',
            goal: 'I want watch TV every day',
            hobby: 'Reading',
            email: 'coolguy@yeet.com',
            number: 1234573885,
            pic: '../assets/images/george.jpg',
        ...
        },
        {
            name: 'Joe Pastucha',
            category: 'Relaxation',
            goal: 'I want to watch 2 movies every week',
            hobby: 'Sleeping',
            email: 'coolguy@yeet.com',
            number: 2314573885,
            pic: '../assets/images/george.jpg',
                ...
                <TouchableOpacity onPress={() => navigation.navigate('BuddyDetails', item)}>
                    ...
                    <Card>
                        <Image source={require('../assets/images/george.jpg')}
                               style={{width: 50, height: 50, position: 'absolute', borderRadius: 6,}}/>
